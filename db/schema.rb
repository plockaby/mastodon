...
ActiveRecord::Schema[7.1].define(version: 2024_02_27_191620) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["account_id", "id", "type"], name: "index_notifications_on_filtered", order: { id: :desc }, where: "((filtered = false) OR (filtered IS NULL))"
